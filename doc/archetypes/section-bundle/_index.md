...
Use the `ref` shortcode. For example, [this is a link to the  getting started]({{< ref "/getting-started" >}}).
...
Thou shalt always use the shortcode {{% gn %}} when referring to this product.
